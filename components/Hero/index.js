        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-16">
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-500 mb-8" data-aos="zoom-y-out" data-aos-delay="150">Add your line up to make instant schedules and timetables.</p>
            </div>
          </div>
          <div className="relative flex justify-center mb-4" data-aos="zoom-y-out" data-aos-delay="450">
            <button className="absolute top-full flex items-center transform -translate-y-1/2 bg-white rounded-full font-medium group pl-4 pb-4 pt-4 pr-6 shadow-lg">
